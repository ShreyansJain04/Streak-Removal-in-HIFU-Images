...
##tried blend factor=0.6 earlier worked best in 5 epochs
##tried blend factor=0.25 earlier worked best in 5 epochs (better than 0.6) 
...
def create_randomized_streaks_and_mask(image, max_streak_width=34, max_streak_length_factor=0.5, streak_spacing_range=(70, 150), blend_factor_range=(0.25, 0.6)):
    """
    Create randomized and irregular streaks on an image and a corresponding mask.
    Each streak will have a random blend factor within the specified range.
    """
    ...
    while x < width:
        ...
        blend_factor = random.uniform(*blend_factor_range)  # Random blend factor for each streak
